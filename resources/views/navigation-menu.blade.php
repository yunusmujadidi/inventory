    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @can('view-any', App\Models\Barang::class)
                <x-jet-responsive-nav-link href="{{ route('barangs.index') }}">
                Barang
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Supplier::class)
                ...
                @endcan
                @can('view-any', App\Models\BarangMasuk::class)
                <x-jet-responsive-nav-link href="{{ route('barang-masuks.index') }}">
                Barang Masuk
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\BarangKeluar::class)
                <x-jet-responsive-nav-link href="{{ route('barang-keluars.index') }}">
                Barang Keluar
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Kategori::class)
                <x-jet-responsive-nav-link href="{{ route('kategoris.index') }}">
                Kategori
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Lokasi::class)
                <x-jet-responsive-nav-link href="{{ route('lokasis.index') }}">
                Lokasi
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Merek::class)
                <x-jet-responsive-nav-link href="{{ route('mereks.index') }}">
                Merek
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\User::class)
