...
class LokasiResource extends Resource
{
    ...
    {
        return $table
            ->columns([Tables\Columns\TextColumn::make('lokasi')->limit(50)])
            ->filters([
    ...
    {
        return [
            LokasiResource\RelationManagers\BarangsRelationManager::class,
            LokasiResource\RelationManagers\BarangKeluarsRelationManager::class,
        ];
    }
